...
*  =======
*
*  PIFILLPAD surrounds a two dimensional local array with a guard-
*  zone initialized to the value CHKVAL. The user may later call the
*  routine PICHEKPAD to discover if the guardzone has been
...
*
*  A       (local input/local output) @(typec), array of
