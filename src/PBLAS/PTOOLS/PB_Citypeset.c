...
*/
   ...
   //WCC TypeStruct.Cgesd2d   = Cigesd2d;
   TypeStruct.Cgesd2d   = wcc_Cigesd2d;
   //WCC TypeStruct.Cgerv2d   = Cigerv2d;
   TypeStruct.Cgerv2d   = wcc_Cigerv2d;
   /*WCC TypeStruct.Cgebs2d   = Cigebs2d; */
   TypeStruct.Cgebs2d   = wcc_Cigebs2d;
   /*WCC TypeStruct.Cgebr2d   = Cigebr2d; */
   TypeStruct.Cgebr2d   = wcc_Cigebr2d;
   //WCC TypeStruct.Cgsum2d   = Cigsum2d;
   TypeStruct.Cgsum2d   = wcc_Cigsum2d;
